...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (userData.getSystolic() >= 90 && userData.getSystolic() <= 140) {
          ...
          holder.notNormal.setVisibility(View.VISIBLE);
            holder.notNormal.setTextColor(context.getResources().getColor(R.color.lightRed));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView date, notNormal;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            notNormal = itemView.findViewById(R.id.not_normal);
